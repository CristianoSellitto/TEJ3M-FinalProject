/*
  ...
  Gives inputs to a 4-bit full adder and subtractor
*/
...
unsigned int inputAFourPin = 6;
unsigned int inputBFourPin = 5;
              ...
              for (int inputBThree = 0; inputBThree < 2; inputBThree++) {
                ...
                for (int inputBTwo = 0; inputBTwo < 2; inputBTwo++) {
                  ...
                  for (int inputBOne = 0; inputBOne < 2; inputBOne++) {
                    ...
                    int xorGateFourOne = inputAFour ^ xorGateSp4;
                    int xorGateFourTwo = carryOutThree ^ xorGateFourOne;
                    int andGateFourOne = inputAFour & xorGateSp4;
